...
module "win_vm" {
  ...
  asg_name = "asg-${regexall("[a-z]+", element(module.win_vm.vm_name), 0)}-${var.short}-${var.loc}-${terraform.workspace}-01" //asg-vmldoeuwdev-ldo-euw-dev-01 - Regex strips all numbers from string
